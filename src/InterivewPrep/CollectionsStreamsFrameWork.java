...
public class CollectionsStreamsFrameWork {
    ...
    public static void main(String[] args) {
        ...
        // So inside Comparator there is a method called compare which will compare two objects of same type
    ...
    static boolean isCheckIsCharacter(String s) {
